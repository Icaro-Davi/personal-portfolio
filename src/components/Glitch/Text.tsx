...
type GlitchTextProps = { children?: ReactNode } & Omit<
  React.HTMLAttributes<HTMLSpanElement>,
  "style"
>;

const GlitchText: FC<GlitchTextProps> = ({ className: CN, children, ...props }) => {
  const childText = extractTextFromChild(children);
  ...
  return (
    <span
      ...
      className={className.text.toClassName(CN)}
      data-text={childText}
      {...props}
    >
      {children}
